...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(custom_prefix_icon user dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status background_jobs date time host os_icon)

POWERLEVEL9K_DATE_FORMAT="%D{%y-%m-%d}"

#-> prefix icon
#POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX="\uE7C5"
POWERLEVEL9K_CUSTOM_PREFIX_ICON=""
POWERLEVEL9K_CUSTOM_PREFIX_ICON_ICON="\uE7C5"
# TODO support color customization for custom commands
#DEFAULT_COLOR_INVERTED=250
#DEFAULT_COLOR=59

#-> colors
POWERLEVEL9K_USER_DEFAULT_BACKGROUND=135
POWERLEVEL9K_USER_DEFAULT_FOREGROUND=235
POWERLEVEL9K_USER_SUDO_BACKGROUND=141
POWERLEVEL9K_USER_SUDO_FOREGROUND=43
POWERLEVEL9K_USER_ROOT_BACKGROUND=141
POWERLEVEL9K_USER_ROOT_FOREGROUND=43
...
POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=148
POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=235
POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=148
POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=235

POWERLEVEL9K_STATUS_OK_BACKGROUND=40
POWERLEVEL9K_STATUS_OK_FOREGROUND=235
POWERLEVEL9K_STATUS_ERROR_BACKGROUND=197
POWERLEVEL9K_STATUS_ERROR_FOREGROUND=235
...
POWERLEVEL9K_HOST_LOCAL_BACKGROUND=206
POWERLEVEL9K_HOST_LOCAL_FOREGROUND=235
POWERLEVEL9K_HOST_REMOTE_BACKGROUND=212
POWERLEVEL9K_HOST_REMOTE_FOREGROUND=235

POWERLEVEL9K_OS_ICON_BACKGROUND=250
POWERLEVEL9K_OS_ICON_FOREGROUND=59
